...
class NavierDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        output_frames = torch.tensor(self.data[idx][10:20], dtype=torch.float32)
        return input_frames, output_frames



def load_navierv1(batch_size, val_batch_size, data_root, num_workers):
...
#     dataloader_train, dataloader_validation, dataloader_test, mean, std = load_navierv1(batch_size=16, 
#                                                                             val_batch_size=16, 
#                                                                             data_root=data_path, 
#                                                                             num_workers=8)